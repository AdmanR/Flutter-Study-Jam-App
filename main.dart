...
void main() {
  runApp(
    MaterialApp(title: "Weather App", home: MyApp()),
  );
}
...
class _MyAppState extends State<MyApp> {
  ...
  Future getData() async {
    http.Response response = await http.get(Uri.parse(
        "https://api.openweathermap.org/data/2.5/weather?q=Vadodara&units=metric&appid=4144bc523f83bc3b48adbf54ca8bacf5"));
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text('Currently in Vadodara',
                      style:
